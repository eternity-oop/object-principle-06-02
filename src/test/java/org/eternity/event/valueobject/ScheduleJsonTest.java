package org.eternity.event.valueobject;
...
public class ScheduleJsonTest {
    ...
    public void to_json_day_of_week_in_month() throws JsonProcessingException, JSONException {
        ...
        JSONAssert.assertEquals("""
                {"name":"미팅","from":"13:00","duration":60,"expression":{"dayOfWeek":"MONDAY","ordinal":2}}""",
                scheduleJson.toJson(),
    ...
    public void to_json_day_of_weeks() throws JsonProcessingException, JSONException {
        ...
        JSONAssert.assertEquals("""
                {"name":"미팅","from":"13:00","duration":60,"expression":{"dayOfWeeks":["MONDAY","TUESDAY"]}}""",
                scheduleJson.toJson(),
                JSONCompareMode.LENIENT);
    }
}
